        ...
        <>
          <footer>
            ...
            <section className='buttonsFlex'>
                <Link to='https://www.facebook.com/uber?uclick_id=138ae22a-f799-4b38-b262-3730b5c3aa13'>
                    <button className='buttons'>
                        <svg className='iconResize' width="1.5em" height="1.5em" viewBox="0 0 24 24" fill="none">
            ...
            <section className='storeContainer'>
                <Link to=''>
                    <img className='storeButtonMobile' width='128' height='38' src="app-store-apple-f1f919205b.svg" alt="Download the Uber app for Android" role="presentation" aria-hidden="true"/>
                </Link>
                <Link to=''>
                    <img className='storeButtonMobile' width='132' src="app-store-google-4d63c31a3e.svg" alt="Download the Uber app for IOS" role="presentation" aria-hidden="true"/>
                </Link>
            </section>
            <p className='copyright'>© 2023 Regal Coder Uber Web-Clone.</p>
          </footer>
        </>
     );
}
