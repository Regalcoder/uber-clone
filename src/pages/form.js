            ...
            <section className="formSection">
               ...
               <Link className="noLine" to='/'>
                   <button className="googleButton">
                       <svg width="18" height="18" viewBox="0 0 256 262" xmlns="http://www.w3.org/2000/svg" class="d4 d5" preserveAspectRatio="xMidYMid">
               ...
               <Link className="noLine" to='/'>
                   <button className="googleButton2">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="#000000" xmlns="http://www.w3.org/2000/svg" class="d4 d5">
               ...
               <Link className="noLine" to='/'>
                   <button className="googleButton3">
                       <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 266.9 266.9">
